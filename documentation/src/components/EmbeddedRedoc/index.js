...
const redocOptions = {
  ...
  theme: {
    colors: {
      ...
      text: {primary: '#e7f0ec', secondary: '#a9bbb3'},
      border: {dark: '#3a4b43', light: '#26352e'},
      success: {main: '#68d4ad'},
      warning: {main: '#f2cc60'},
      error: {main: '#ff7b72'},
    },
    ...
    rightPanel: {backgroundColor: '#0b0f0d', textColor: '#e7f0ec'},
    schema: {
    ...
    codeBlock: {backgroundColor: '#0b0f0d'},
    typography: {
      ...
      code: {color: '#91e0c3', backgroundColor: '#181e1b'},
      links: {color: '#68d4ad', visited: '#83dcbc', hover: '#bbead9'},
    },
  },
};
...
export default function EmbeddedRedoc() {
  ...
  return (
    <div className="redoclyEmbeddedReference" ref={containerRef}>
