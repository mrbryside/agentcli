...
handler context after admission.
...
rounds request any available tool. Repair rounds expose only missing
finalizers, and a single missing tool receives a one-shot specific choice.
