...
| Runtime architecture, context compaction, and event semantics | [architecture/index.md](architecture/index.md) |
...
| Runtime logging, LLM-call observability, and Langfuse export | [observability/index.md](observability/index.md) |
