...
setup. The repository playground profile declares 120,000 context tokens and
65,000 output tokens for its custom model, so the opening Terminal UI banner
