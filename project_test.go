...
`)
	...
	for _, expected := range []string{
		...
		"retained task candidates with both agent and task_id",
		"Treat them as choices, not as an instruction to resume",
		"continues, answers, or corrects that work",
		"request is unrelated or new, create a new task",
